...
### 7.5 Подготовка к CRUD (В работе)
- [ ] Проектирование эндпоинтов: `POST`, `PUT`, `DELETE` для `/api/strains`.
- [ ] Планирование форм на фронтенде на базе React Hook Form + zod.

**Следующий шаг**: реализация полноценного CRUD для сущности **Strain**.
...
- **Bash скрипты**: 1 установочный скрипт
